...
# ── Config ────────────────────────────────────────────────────────────────────
GENERATIONS_FILE = Path("results/t5-base_LoL1921_f/predictions.jsonl") # change to correct path
OUTPUT_FILE      = Path("results/t5-base_LoL1921_f/faithfulness.json") # change to correct path
PENALTY_LAMBDA   = 0.5
